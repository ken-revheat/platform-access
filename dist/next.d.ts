...
export declare class EntitlementError extends Error {
    readonly entitlement: Exclude<Entitlement, "entitled">;
    constructor(entitlement: Exclude<Entitlement, "entitled">);
}
 ...
 */
export declare function createPlatformAccessNext(core: PlatformAccessCore, opts: PlatformAccessNextOptions): PlatformAccessNext;
